...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login Logout Metrodata Academy/input__password'), 'AJxgTO7PuudFJYJNyubGtA==')

WebUI.click(findTestObject('Object Repository/Page_Login Logout Metrodata Academy/button_Masuk'))

WebUI.click(findTestObject('Object Repository/Page_Login Logout Metrodata Academy/button_Hendrik Christian'))

WebUI.click(findTestObject('Object Repository/Page_Login Logout Metrodata Academy/button_Keluar'))
